...
class _MyAppState extends State<MyApp> {
    ...
    Timer.periodic(const Duration(seconds: 1), (Timer timer) {
      ...
      accelerometerEvents.listen((AccelerometerEvent accelerometerEvent) {
        gyroscopeEvents.listen((GyroscopeEvent gyroscopeEvent) {
          ...
          yawAngle = initialYaw + yawGyro; // Adjust yaw from the initial position
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Mobile Sensors Data',
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Mobile Sensors Data'),
        ),
        body: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              Text('Roll Angle: ${rollAngle.toStringAsFixed(0)} degrees'),
              Text('Roll Direction: $rollDirection'),
              const SizedBox(height: 20),
              Text('Pitch Angle: ${pitchAngle.toStringAsFixed(0)} degrees'),
              Text('Pitch Direction: $pitchDirection'),
              const SizedBox(height: 20),
              Text('Yaw Angle: ${yawAngle.toStringAsFixed(0)} degrees'),
...
//   double alpha = 0.98; // Complementary filter coefficient
//   String rollDirection = 'Not Rolling';
//   String pitchDirection = 'Not Tilted';
//   String yawDirection = 'Not Rotating';
//
//   @override
//   void initState() {
...
//       // Stop updating angles after 5 seconds
//       accelerometerEvents.listen((AccelerometerEvent accelerometerEvent) {
//         gyroscopeEvents.listen((GyroscopeEvent gyroscopeEvent) {
//           double rollGyro = gyroscopeEvent.z;
//           double pitchGyro = gyroscopeEvent.x;
...
//           // Combine gyroscope and accelerometer data using a complementary filter
//           rollAngle = alpha * (rollAngle + rollGyro) + (1 - alpha) * rollAccel;
//           pitchAngle = alpha * (pitchAngle + pitchGyro) + (1 - alpha) * pitchAccel;
//           yawAngle += yawGyro;
//
//           // Round off angle values
//           rollAngle = double.parse(rollAngle.toStringAsFixed(2));
...
//           rollDirection = getRollDirection(rollAngle);
//           pitchDirection = getPitchDirection(pitchAngle);
//           yawDirection = getYawDirection(yawGyro);
//
//           setState(() {});
//         });
//       });
...
//   }
//
//   String getYawDirection(double gyroValue) {
//     if (gyroValue > 0.5) {
...
//       home: Scaffold(
//         appBar: AppBar(
//           title: Text('Orientation Angle and Direction'),
//         ),
//         body: Center(
//           child: Column(
//             mainAxisAlignment: MainAxisAlignment.center,
//             children: <Widget>[
//               Text('Roll Angle: ${rollAngle.toStringAsFixed(2)} degrees'),
//               Text('Roll Direction: $rollDirection'),
//               SizedBox(height: 20),
//               Text('Pitch Angle: ${pitchAngle.toStringAsFixed(2)} degrees'),
//               Text('Pitch Direction: $pitchDirection'),
//               SizedBox(height: 20),
//               Text('Yaw Angle: ${yawAngle.toStringAsFixed(2)} degrees'),
//               Text('Yaw Direction: $yawDirection'),
//             ],
//           ),
//         ),
...
//
// class _MyAppState extends State<MyApp> {
//   double rollAngle = 0; // Initial roll angle
//   double pitchAngle = 0; // Initial pitch angle
//   double yawAngle = 0; // Initial yaw angle
//   double alpha = 0.98; // Complementary filter coefficient
//   String rollDirection = 'Not Rolling';
...
//     super.initState();
//
//     // Create a timer to update values every 5 seconds
...
//           pitchAngle = alpha * (pitchAngle + pitchGyro) + (1 - alpha) * pitchAccel;
//
//           // Calculate yaw angle directly from the gyroscope data
//           yawAngle += yawGyro;
//
//           // Update the direction based on the angles
//           rollDirection = getRollDirection(rollAngle);
...
//       home: Scaffold(
//         appBar: AppBar(
//           title: Text('Roll Angle Calculator'),
//         ),
//         body: Center(
//           child: Column(
//             mainAxisAlignment: MainAxisAlignment.center,
...
//               Text('Roll Angle: ${rollAngle.toStringAsFixed(2)} degrees'),
//               SizedBox(height: 20),
//               Text(getRollDirection(rollAngle)),
//             ],
//           ),
//         ),
//       ),
...
//             Center(
//               child: Text(
//                 'Rolling Angle: ${initialAngle.toStringAsFixed(2)} degrees',
...
//       final timeInterval = 0.1000; // Change this to your desired interval in seconds
//
...
//       final rollingAngle = initialAngle + integratedAngle * (180 / 3.14159265359);
//
//       setState(() {
//         initialAngle = rollingAngle;
//       });
//     });
//
//     _fetchPermissionStatus();
